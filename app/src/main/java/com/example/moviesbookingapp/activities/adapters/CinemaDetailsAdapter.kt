...
import com.example.moviesbookingapp.activities.viewholders.CinemaDetailsViewHolder

class CinemaDetailsAdapter(val isExpanded:Boolean,val context:Context): RecyclerView.Adapter<CinemaDetailsViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CinemaDetailsViewHolder {
        ...
        return CinemaDetailsViewHolder(view,isExpanded,context)
    }
